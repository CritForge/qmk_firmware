...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65(
    ...
    KC_LCTL, KC_LGUI, MO(_FN1),KC_LALT, KC_SPC,           KC_SPC,  KC_SPC,  KC_RALT, KC_RCTL, MO(_FN1), KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_FN1] = LAYOUT_65(
    ...
    KC_TILD, _______, _______, _______, RESET,          RESET    , RESET,   _______, _______, _______, _______, _______, _______
  )
};
